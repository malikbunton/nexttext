...
public class OnMouseProxi extends Condition {
     ...
     */
    public OnMouseProxi(Action trueAction) {
        this(trueAction, new DoNothing(),300);
    }
    /**
     * Creates an OnMouseProxi which performs one of the given Actions, depending
    ...
    public OnMouseProxi(Action trueAction, double distance) {
    ...
    public OnMouseProxi(Action trueAction, Action falseAction) {
    ...
    public OnMouseProxi(Action trueAction, Action falseAction, double distance) {
