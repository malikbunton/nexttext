...
public class Blow extends DForm implements TargetingAction {
     ...
     * @param target repulsion point
     * @param speed is the speed with which the points are pushed.
     * @param reach will push farther points faster with a higher value.
     */
     ...
     * @param reach
     */
    public Blow ( float x, float y, float speed, float reach ) {
    ...
    public ActionResult behave(TextObjectGlyph to) {
        ...
        // from it to the target and move it a fraction of this distance away from the target.
